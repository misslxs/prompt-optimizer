...
export default {
  ...
  test: {
    ...
    image: {
      ...
      urlCheck: "Validate",
      urlChecking: "Validating image URL...",
      urlValid: "Image URL is reachable",
      urlInvalid: "Invalid image URL format",
      urlUnreachable: "Image URL is not reachable",
      fileReady: "Image selected",
      fileLoading: "Reading image...",
      fileInvalid: "Please select an image file",
